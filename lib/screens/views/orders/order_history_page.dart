        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text("Статус заказа №1342",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 16,left: 12),
              child: Text("Филиал принял",style: TextStyle(fontSize: 17,color: Color(0xfff51267D))),
            ),
            Padding(
